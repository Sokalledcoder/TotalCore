---
source: https://www.scichart.com/documentation/js/v4/get-started/faqs/faq-20250722
scraped_at: 2025-11-28T18:24:58.355399
---

# https://www.scichart.com/documentation/js/v4/get-started/faqs/faq-20250722
...
The difficulty was not converting TypeScript to JavaScript but how to handle imports for `SciChart.js`

and `RxJS`

.

First we need to create `index.html`
...
First we load RxJS from CDN. Next we add importmap to define `scichart`

module which we also load from CDN. Finally we add the main `index.js`

file which have `type="module"`

this means it is ES module and we can use imports in the browser.
