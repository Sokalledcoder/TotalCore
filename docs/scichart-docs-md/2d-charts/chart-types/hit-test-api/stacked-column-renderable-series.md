---
source: https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/hit-test-api/stacked-column-renderable-series
scraped_at: 2025-11-28T18:24:34.054327
---

# https://www.scichart.com/documentation/js/v4/2d-charts/chart-types/hit-test-api/stacked-column-renderable-series

# Hit-Test API for Stacked Column Series

## The hitTest method on Stacked Column Series

The **IHitTestProvider.hitTest** method on StackedColumnRenderableSeries tests if the click was within a stacked column.
...
- Test if the click was within the column body and update
...
The **StackedColumnCollection** in this example has five StackedColumnRenderableSeries📘. Therefore, we use **reduce** function to iterate over each renderable series and to accumulate the result.
...
The **IHitTestProvider.hitTestDataPoint** method is not supported for StackedColumnRenderableSeries📘.
...
- Sets
**HitTestInfo.isHit**property**True**if the mouse click was over the column bar.