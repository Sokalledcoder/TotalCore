---
source: https://tradingview.github.io/lightweight-charts/docs/time-zones
scraped_at: 2025-12-01T14:31:46.635131
---
...
timestamp in UTC. You want to display it in the `Europe/Moscow`

time zone, which has the `UTC+03:00`

offset according to the IANA time zone database. To do this, adjust the original UTC timestamp by adding 3 hours. Therefore, the new timestamp should be `2021-01-01T13:00:00.000Z`
...
You can use the `utcToZonedTime`
