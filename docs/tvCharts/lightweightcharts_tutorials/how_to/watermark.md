---
source: https://tradingview.github.io/lightweight-charts/tutorials/how_to/watermark
scraped_at: 2025-12-01T16:04:01.089342
---
...
A simple text watermark can be configured and added by using the `createTextWatermark`
...
If a simple text watermark doesn't meet your requirements then you can use the Image watermark via `createImageWatermark`
