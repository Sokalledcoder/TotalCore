---
source: https://tradingview.github.io/lightweight-charts/tutorials/how_to/horizontal-price-scale
scraped_at: 2025-12-01T16:03:56.785105
---
...
interface allows you to customize the behavior of the
horizontal scale. By default, this scale uses time values, but
...
interface consists of several methods that you need to
...
parameter will contain the settings you want to apply. Use
...
Extend the `LocalizationOptions`

interface to include a `precision`
...
class implements the `IHorzScaleBehavior`
