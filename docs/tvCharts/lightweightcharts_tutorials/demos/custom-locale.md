---
source: https://tradingview.github.io/lightweight-charts/tutorials/demos/custom-locale
scraped_at: 2025-12-01T16:03:52.191603
---
...
The function `setLocale(locale)`

is defined to change the locale of the chart
using `chart.applyOptions`

method. It adjusts the `localization`

property of the
chart options, specifically the `locale`
...
varies depending on the set locale to mirror customary date formats
...
locale is applied to the chart by invoking `setLocale(locale)`
